![banner](https://lexis-solutions-apify.fra1.cdn.digitaloceanspaces.com/banners/boligsiden.png)
...
This repository includes example code showing how to integrate the `boligsiden-dk-scraper` actor into your projects.
...
<p align="center">
  <img src="https://apify-image-uploads-prod.s3.us-east-1.amazonaws.com/fas6RkZwfTg9LQHCl/kG5R6bKysytSuPxI5-unnamed1.png" alt="Boligsiden.dk Scraper" style="height: 60px; margin-right: 15px;" /><a href="https://apify.com/lexis-solutions/boligsiden-dk-scraper" target="_blank">
...
```json
{
  ...
  "price": 2495000,
  "priceCurrency": "DKK",
  "description": "YDERST VELBELIGGENDE EJENDOM I HASSERIS· Allerbedste beliggenhed på blind vej\n· Bo lige op til grønne arealer...",
...
- Switzerland Properties Scraper - [FlatFox.ch](https://apify.com/lexis-solutions/flatfox-ch-properties-scraper)
- Sweden Properties Scraper - [Hemnet.se](https://apify.com/lexis-solutions/hemnet-se-scraper)

## Want something custom-built?

This FlatFox Properties Scraper doesn’t exactly do what you need? You can always build your own! Lexis Solutions is a [certified Apify Partner](https://apify.com/partners/find). We can help you with custom solutions or data extraction projects.
